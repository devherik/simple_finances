...
class PageNewTransaction extends StatefulWidget {
  const PageNewTransaction({super.key});

  @override
  State<PageNewTransaction> createState() => _PageNewTransactionState();
}

class _PageNewTransactionState extends State<PageNewTransaction> {
